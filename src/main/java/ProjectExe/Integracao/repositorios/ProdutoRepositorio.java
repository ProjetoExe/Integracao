...
public interface ProdutoRepositorio extends JpaRepository<Produto, Long> {
    ...
    @Query("SELECT p FROM Produto p JOIN p.categorias c JOIN p.marca m JOIN p.grade pg " +
    ...
    Page<Produto> findByParametros(String nome, Long ean, Integer optAtivo, List<String> marcas, List<String> categorias, BigDecimal precoInicial, BigDecimal precoFinal, Double estoqueInicial, Double estoqueFinal, Pageable pageable);
}